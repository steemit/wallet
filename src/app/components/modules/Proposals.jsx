...
class Proposals extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        if (this.props.walletSectionAccount) {
            if (prevProps.walletSectionAccount !== this.props.walletSectionAccount) {
                this.updateProposalVotes(this.props.walletSectionAccount);
            }
        } else {
    ...
    getAllProposals(
        ...
        return this.props.listProposals({
            voter_id: this.props.walletSectionAccount || this.props.currentUser,
            last_proposal,
            order_by,
            order_direction,
            limit,
    ...
    render() {
        ...
        return (
            <div className="row">
                ...
                />
                <center style={{ paddingTop: '1em', paddingBottom: '1em', width: '100%' }}>
                    {!loading ? (
                        <span
                            role="button"
                            className="btn-link"
